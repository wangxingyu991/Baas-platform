    ...
    <div class="rh-top-head">
      <div class="rh-logo" :class="{'shrink':!(isNavShow)}">
        <div class="rh-logo-img">
            <svg t="1634714360180" class="icon" viewBox="0 0 1170 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4155" width="28" height="28"><path d="M223.056457 512.193097l139.6736 242.015086-111.118628 193.793463-251.611429-435.808549 254.537143-440.846628 111.118628 193.799314z" fill="#fff" p-id="4156"></path><path d="M767.648914 823.25504l-1.462857 2.568777h-165.302857l43.183543-75.24352 40.96-71.445943 98.7136-172.090514-98.655086-171.979337-40.96-71.445943-37.2736-65.00352h159.3344l97.543314 168.930743 83.499886 144.647314-80.515657 139.498057-99.064686 171.563886z m207.2576-649.508571L877.714286 5.459383h-579.057372l110.767543 193.155657 135.9872 237.099886 40.96 71.440091-40.96 71.39328-141.546057 246.871772-111.060114 193.565257h584.9088l1.111771-1.930972 99.006172-171.505371 192.453485-333.355886-195.3792-338.446628z" fill="#fff" p-id="4157"></path></svg>
        </div>
        <div class="rh-logo-text" v-show="isNavShow">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      navHeight: 0,//导航高度
      navWidth: 240,//导航宽度50/240
      WinHeight: 0,//浏览器窗口高度
      contentWidth: 1920,//内容区宽度
      contentLeft: 240,//内容去距离左侧位置距离、50/240
